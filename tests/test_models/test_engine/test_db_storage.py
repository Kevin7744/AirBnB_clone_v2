...
class TestFileStorage(unittest.TestCase):
    """ Class to the test the database storage method """
    def test_new(self):
        """ New object is correctly added to database """
        new = User(
            email='kevinkirui@gmail.com',
            password='password',
            first_name='kevin',
            last_name='kirui'
        )
        ...
        dbc = MySQLdb.connect(
            host=os.getenv('HBNB_MYSQL_USER'),
            port=3306,
        ...
        self.assertIn('kevinkirui@gmail.com', result)
    ...
    def test_delete(self):
        ...
        result = cursor.fetchone()
        self.assertTrue(result is not None)
        self.assertIn('kevinkrui@gmail.com', result)
        self.assertIn('password', result)
        self.assertIn('kevin', result)
        self.assertIn('kirui', result)
